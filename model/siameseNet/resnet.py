...
def resnet50(pretrained=True, root='pretrained', **kwargs):  # 默认参数不能为r'xxxxx'
    ...
    if pretrained:
        model_pth = '/root/autodl-tmp/DASNet-master/pretrained/resnet50-19c8e357.pth'
